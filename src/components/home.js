    ...
    <>
        ...
        rounded-lg shadow-lg">
            ...
            <div className="mr-2 text-center my-auto  xl:w-2/5">
                ...
                <a href="/register">
                <button className="bg-indigo-400  hover:bg-indigo-500 duration-500 text-white xl:text-2xl rounded-md p-1 sm:py-2 mt-2">Sign Up</button>
                </a>
            </div>
            }
        </div>
        <div className="w-11/12 lg:w-7/12 xl:w-6/12 mx-auto text-center mt-6 md:grid md:grid-cols-2 bg-indigo-400 rounded-lg shadow-lg p-2 ">
            <div>
