...
function Home({token}) {
    return(
        ...
        <div className="mt-32 pt-10 pb-10 flex w-4/5 lg:w-3/5 lg:h-2/4 xl:h-auto mx-auto justify-center bg-white grid-cols-2 grid-rows-1
        rounded-lg shadow-lg">
            ...
            <button className="bg-violet-500 md:mt-2 hover:bg-violet-600 text-white xl:text-4xl rounded-md py-2 px-4">Play</button>
            </a>
        </div>
