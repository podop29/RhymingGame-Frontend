...
function Home({token}) {
    return(
    <>
        <div className="mt-32 pt-10 pb-10 flex w-4/5 lg:w-7/12 lg:h-2/4 xl:h-auto mx-auto justify-center bg-white grid-cols-2 grid-rows-1
        rounded-lg shadow-lg">
            ...
            {token ?
            <div className="text-center mt-0  w-2/5">
                <h1 className="text-center md:mt-5 text-slate-500 text-xl md:text-4xl xl:text-5xl pb-4">Play a game!</h1>
                <a href="/game">
                    <button className="bg-indigo-500 md:mt-2 hover:bg-indigo-400 text-white xl:text-4xl rounded-md p-1 sm:py-2 px-4">Play</button>
                </a>
        </div>
            
            :
            <div className="mr-2 text-center my-auto  xl:w-2/5">
                <h1 className="text-center md:mt-5 text-gray-500 text-xl md:text-4xl xl:text-5xl sm:pb-4">Don't have an account?</h1>
                <p className="xl:text-2xl absolute sm:static invisible sm:visible text-slate-500 xl:mb-4">Register for free below</p>
                <a href="/register">
                <button className="bg-indigo-400  hover:bg-indigo-500 duration-500 text-white xl:text-4xl rounded-md p-1 sm:py-2 ">Sign Up</button>
                </a>
            </div>
            }
        </div>
        <div className="w-11/12 md:w-6/12 mx-auto text-center mt-6 md:grid md:grid-cols-2 bg-indigo-400 rounded-lg shadow-lg p-2 ">
            <div>
                <h1 className="text-3xl mb-2 text-white font-semibold">What is RhymeTime?</h1>
                <p className="text-lg text-white mx-8">RhymeTime is a student project created by Stevan Grubac
            ...
            <div>
                <h1 className="text-3xl mb-2 text-white font-semibold">How it works?</h1>
                <p className="text-lg text-white mx-8">
                    ...
                    <div className="bg-indigo-300 rounded-2xl shadow-2xl p-1 w-5/6 mx-auto flex">
                        <a className="my-auto mx-auto" href="https://www.linkedin.com/in/stevan-grubac-779306228/">                
                            <img className='h-10' src={liLogo}/>
                        </a>
